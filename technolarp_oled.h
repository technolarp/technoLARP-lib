...
class M_oled
{
  ...
  public:  
	...
	void displayFillRect(uint16_t x0, uint16_t y0, uint16_t w, uint16_t h, uint16_t color);
	
	void displayFillTriangle(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t color);
